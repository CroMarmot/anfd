...
import { ɵisPromise as _isPromise, ɵRuntimeError as _RuntimeError, Injectable, ɵisNgModule as _isNgModule, isStandalone, createEnvironmentInjector, InjectionToken, EventEmitter, input, inject, ViewContainerRef, ChangeDetectorRef, Directive, Input, Output, reflectComponentType, Component, ɵisInjectable as _isInjectable, runInInjectionContext, Compiler, NgModuleFactory, afterNextRender, EnvironmentInjector as EnvironmentInjector2, DestroyRef, ɵConsole as _Console, ɵPendingTasksInternal as _PendingTasksInternal, ɵINTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER } from "@angular/core";
...
var RouterOutlet = class _RouterOutlet {
    ...
    get component() {
        if (!this.activated)
            throw new _RuntimeError(4012, (typeof ngDevMode === "undefined" || ngDevMode) && "Outlet is not activated");
...
function namedOutletsRedirect(redirectTo) {
    return throwError(new _RuntimeError(4e3, (typeof ngDevMode === "undefined" || ngDevMode) && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
...
var ApplyRedirects = class {
    ...
    findPosParam(redirectTo, redirectToUrlSegment, posParams) {
        ...
        if (!pos)
            throw new _RuntimeError(4001, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot redirect to '${redirectTo}'. Cannot find '${redirectToUrlSegment.path}'.`);
        return pos;
    }
...
var NavigationTransitions = class _NavigationTransitions {
    ...
    environmentInjector = inject(EnvironmentInjector2);
...
var DefaultRouteReuseStrategy = class _DefaultRouteReuseStrategy extends BaseRouteReuseStrategy {
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function DefaultRouteReuseStrategy_Factory(__ngFactoryType__) {
            return (ɵDefaultRouteReuseStrategy_BaseFactory || (ɵDefaultRouteReuseStrategy_BaseFactory = i0.ɵɵgetInheritedFactory(_DefaultRouteReuseStrategy)))(__ngFactoryType__ || _DefaultRouteReuseStrategy);
        };
    })();
    static ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
var HistoryStateManager = class _HistoryStateManager extends StateManager {
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function HistoryStateManager_Factory(__ngFactoryType__) {
            return (ɵHistoryStateManager_BaseFactory || (ɵHistoryStateManager_BaseFactory = i0.ɵɵgetInheritedFactory(_HistoryStateManager)))(__ngFactoryType__ || _HistoryStateManager);
        };
    })();
    static ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
function afterNextNavigation(router, action) {
    ...
    /* NavigationResult.REDIRECTING */ ), take(1)).subscribe(() => {
        action();
    });
}
...
var Router = class _Router {
    ...
    location = inject(Location);
    urlHandlingStrategy = inject(UrlHandlingStrategy);
    injector = inject(EnvironmentInjector2);
    /**
...
import { LOCATION_INITIALIZED, ViewportScroller as ViewportScroller2, LocationStrategy as LocationStrategy2, HashLocationStrategy, Location as Location2, PathLocationStrategy } from "@angular/common";
import * as i02 from "@angular/core";
import { signal, untracked, inject as inject2, ɵINTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER2, HostAttributeToken, ɵRuntimeError as _RuntimeError2, booleanAttribute, Directive as Directive2, Attribute, HostBinding, Input as Input2, HostListener, EventEmitter as EventEmitter2, Optional, ContentChildren, Output as Output2, Injectable as Injectable2, createEnvironmentInjector as createEnvironmentInjector2, InjectionToken as InjectionToken2, makeEnvironmentProviders, APP_BOOTSTRAP_LISTENER, Injector, ApplicationRef, provideAppInitializer, ɵperformanceMarkFeature as _performanceMarkFeature, ENVIRONMENT_INITIALIZER, NgZone as NgZone2, SkipSelf, NgModule } from "@angular/core";
import { Subject as Subject2, of as of2, from as from2 } from "rxjs";
import { mergeAll, catchError as catchError2, filter as filter2, concatMap as concatMap2, mergeMap as mergeMap2 } from "rxjs/operators";
var RouterLink = class _RouterLink {
    ...
    subscription;
    /** @internal */
    onChanges = new Subject2();
    applicationErrorHandler = inject2(_INTERNAL_APPLICATION_ERROR_HANDLER2);
    ...
    ngOnChanges(changes) {
        if (ngDevMode && isUrlTree(this.routerLinkInput) && (this.fragment !== void 0 || this.queryParams || this.queryParamsHandling || this.preserveFragment || this.relativeTo)) {
            throw new _RuntimeError2(4016, "Cannot configure queryParams or fragment when using a UrlTree as the routerLink input value.");
        }
        if (this.isAnchorElement) {
            this.updateHref();
            this.subscribeToNavigationEventsIfNecessary();
    ...
    static ɵfac = function RouterLink_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _RouterLink)(i02.ɵɵdirectiveInject(Router), i02.ɵɵdirectiveInject(ActivatedRoute), i02.ɵɵinjectAttribute("tabindex"), i02.ɵɵdirectiveInject(i02.Renderer2), i02.ɵɵdirectiveInject(i02.ElementRef), i02.ɵɵdirectiveInject(i3.LocationStrategy));
    };
    static ɵdir = /* @__PURE__ */ i02.ɵɵdefineDirective({
        ...
        hostBindings: function RouterLink_HostBindings(rf, ctx) {
            if (rf & 1) {
                i02.ɵɵlistener("click", function RouterLink_click_HostBindingHandler($event) {
                    return ctx.onClick($event.button, $event.ctrlKey, $event.shiftKey, $event.altKey, $event.metaKey);
                });
            }
            if (rf & 2) {
                i02.ɵɵattribute("href", ctx.reactiveHref(), i02.ɵɵsanitizeUrlOrResourceUrl)("target", ctx.target);
            }
        },
        inputs: {
            target: "target",
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(RouterLink, [{
            type: Directive2,
            args: [{
                    selector: "[routerLink]",
                    host: {
...
var RouterLinkActive = class _RouterLinkActive {
     ...
     * ```
     */
    isActiveChange = new EventEmitter2();
    ...
    /** @docs-private */
    ngAfterContentInit() {
        of2(this.links.changes, of2(null)).pipe(mergeAll()).subscribe(_ => {
            this.update();
    ...
    subscribeToEachLinkOnChanges() {
        ...
        this.linkInputChangesSubscription = from2(allLinkChanges).pipe(mergeAll()).subscribe(link => {
    ...
    static ɵfac = function RouterLinkActive_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _RouterLinkActive)(i02.ɵɵdirectiveInject(Router), i02.ɵɵdirectiveInject(i02.ElementRef), i02.ɵɵdirectiveInject(i02.Renderer2), i02.ɵɵdirectiveInject(i02.ChangeDetectorRef), i02.ɵɵdirectiveInject(RouterLink, 8));
    };
    static ɵdir = /* @__PURE__ */ i02.ɵɵdefineDirective({
        ...
        contentQueries: function RouterLinkActive_ContentQueries(rf, ctx, dirIndex) {
            if (rf & 1) {
                i02.ɵɵcontentQuery(dirIndex, RouterLink, 5);
            }
            if (rf & 2) {
                let _t;
                i02.ɵɵqueryRefresh(_t = i02.ɵɵloadQuery()) && (ctx.links = _t);
            }
        },
        inputs: {
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(RouterLinkActive, [{
            type: Directive2,
            args: [{
...
var PreloadAllModules = class _PreloadAllModules {
    preload(route, fn) {
        return fn().pipe(catchError2(() => of2(null)));
    }
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(PreloadAllModules, [{
            type: Injectable2,
            args: [{
                    providedIn: "root"
                }]
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(NoPreloading, [{
            type: Injectable2,
            args: [{
                    providedIn: "root"
                }]
...
var RouterPreloader = class _RouterPreloader {
    ...
    setUpPreloading() {
        this.subscription = this.router.events.pipe(filter2(e => e instanceof NavigationEnd), concatMap2(() => this.preload())).subscribe(() => { });
    }
    preload() {
    ...
    processRoutes(injector, routes) {
        ...
        for (const route of routes) {
            if (route.providers && !route._injector) {
                route._injector = createEnvironmentInjector2(route.providers, injector, `Route: ${route.path}`);
            }
        ...
        return from2(res).pipe(mergeAll());
    }
    preloadConfig(injector, route) {
        return this.preloadingStrategy.preload(route, () => {
            ...
            if (route.loadChildren && route.canLoad === void 0) {
                ...
                loadedChildren$ = of2(null);
            }
            const recursiveLoadChildren$ = loadedChildren$.pipe(mergeMap2(config => {
                if (config === null) {
                    return of2(void 0);
                }
            ...
            if (route.loadComponent && !route._loadedComponent) {
                ...
                return from2([recursiveLoadChildren$, loadComponent$]).pipe(mergeAll());
            }
            else {
    ...
    static ɵfac = function RouterPreloader_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _RouterPreloader)(i02.ɵɵinject(Router), i02.ɵɵinject(i02.EnvironmentInjector), i02.ɵɵinject(PreloadingStrategy), i02.ɵɵinject(RouterConfigLoader));
    };
    static ɵprov = /* @__PURE__ */ i02.ɵɵdefineInjectable({
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(RouterPreloader, [{
            type: Injectable2,
            args: [{
                    providedIn: "root"
                }]
...
var ROUTER_SCROLLER = new InjectionToken2("");
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(RouterScroller, [{
            type: Injectable2
        }], () => [{
            type: UrlSerializer
        }, {
...
var ROUTER_IS_PROVIDED = new InjectionToken2("", {
    providedIn: "root",
    factory: () => false
});
...
function withInMemoryScrolling(options = {}) {
    const providers = [{
            ...
            useFactory: () => {
                const viewportScroller = inject2(ViewportScroller2);
                const zone = inject2(NgZone2);
...
var BOOTSTRAP_DONE = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "bootstrap done indicator" : "", {
    factory: () => {
        return new Subject2();
    }
});
var INITIAL_NAVIGATION = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "initial navigation" : "", {
    providedIn: "root",
    factory: () => 1
            ...
            return locationInitialized.then(() => {
                return new Promise(resolve => {
                    ...
                    injector.get(NavigationTransitions).afterPreactivation = () => {
                        resolve(true);
                        return bootstrapDone.closed ? of2(void 0) : bootstrapDone;
                    };
                    router.initialNavigation();
                });
            });
...
var ROUTER_PRELOADER = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "router preloader" : "");
...
var ROUTER_FORROOT_GUARD = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "router duplicate forRoot guard" : "");
var ROUTER_PROVIDERS = [Location2, {
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(RouterModule, [{
            type: NgModule,
            args: [{
...
function provideRouterScroller() {
    return {
        ...
        useFactory: () => {
            const viewportScroller = inject2(ViewportScroller2);
            const zone = inject2(NgZone2);
            const config = inject2(ROUTER_CONFIGURATION);
            const transitions = inject2(NavigationTransitions);
            const urlSerializer = inject2(UrlSerializer);
...
function provideForRootGuard(router) {
    if (router) {
        throw new _RuntimeError2(4007, `The Router was provided more than once. This can happen if 'forRoot' is used outside of the root injector. Lazy loaded modules should use RouterModule.forChild() instead.`);
    }
    return "guarded";
}
...
var ROUTER_INITIALIZER = new InjectionToken2(typeof ngDevMode === "undefined" || ngDevMode ? "Router Initializer" : "");
...
import { inject as inject3, Version } from "@angular/core";
import "@angular/common";
import "rxjs";
import "rxjs/operators";
import "@angular/platform-browser";
function mapToCanMatch(providers) {
    return providers.map(provider => (...params) => inject3(provider).canMatch(...params));
}
function mapToCanActivate(providers) {
    return providers.map(provider => (...params) => inject3(provider).canActivate(...params));
}
function mapToCanActivateChild(providers) {
    return providers.map(provider => (...params) => inject3(provider).canActivateChild(...params));
}
function mapToCanDeactivate(providers) {
    return providers.map(provider => (...params) => inject3(provider).canDeactivate(...params));
}
function mapToResolve(provider) {
    return (...params) => inject3(provider).resolve(...params);
}
